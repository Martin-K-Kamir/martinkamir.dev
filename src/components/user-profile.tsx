                    ...
                    {links.map(link => (
                        <li key={link.label}>
                            <a
                                ...
                                className="flex items-center gap-2 text-sm font-medium text-zinc-100/95 outline-offset-4 outline-zinc-100/95 transition-colors hover:underline focus-visible:outline-2 sm:gap-2.5 [&>svg]:size-4"
